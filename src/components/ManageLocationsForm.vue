<template>
  <div class="bg-white dark:bg-slate-800 dark:text-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
    ...
    <div class="flex flex-row items-center mb-8">
      ...
      >
      <MagnifyingGlassIcon class="w-8 h-8 text-gray-500" />
    </div>
    ...
    >
      <div class="flex flex-col">
        <div class="flex flex-row items-center">
          <MapPinIcon class="w-4 h-4 mr-2 text-gray-500 dark:text-gray-300" />
...
import { MapPinIcon, MagnifyingGlassIcon, TrashIcon } from '@heroicons/vue/24/solid'
...
export default {
  ...
  methods: {
     ...
     */
    searchCity (city) {
      return axios.get(`${openWeatherUrl}/geo/1.0/direct`, {
        params: {
          q: city,
          limit: 5,
